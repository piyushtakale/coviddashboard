...
public class StateOne extends HttpServlet{
    ...
    protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    	...
    	try{
            ...
            String stateto = req.getParameter("statename");
            stateto = stateto.replace("-", " ");
...
//		    query.put("state_code", "MH");
            FindIterable<Document> fe = col.find(new Document("state_name", stateto));
            ...
            Block<Document> printBlock = new Block<Document>() {
                ...
                public void apply(final Document document) {
                	...
                	obj.put("dailyRecoveredCases", document.getInteger("state_recovered_day"));
                	...
                	obj.put("recoveredCases", document.getInteger("state_recovered"));
